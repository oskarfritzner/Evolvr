                        ...
                        <View style={styles.icon}>
                          {item.title === "Delete Account" && isDeleting ? (
                            ...
                            <Ionicons
                              ...
                              size={24}
                              color={
                                item.danger ? colors.error : colors.textPrimary
                              }
                            />
                          )}
                        </View>
          ...
          >
            ...
            >
              ...
              <Text style={[styles.modalText, { color: colors.textSecondary }]}>
                Push notifications are coming soon to help you stay on track
                with your daily check-ins and tasks. Stay tuned for updates!
              </Text>
