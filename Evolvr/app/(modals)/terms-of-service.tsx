        ...
        <View style={styles.maxWidthContainer}>
          <View style={[styles.section, { backgroundColor: colors.surface }]}>
            ...
            <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
              By accessing or using Evolvr, you agree to be bound by these Terms
            ...
            <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
              Evolvr provides a platform for personal journaling and reflection.
            ...
            <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
              You retain all rights to the content you create through our
              service. By submitting content, you grant us a license to use,
              store, and process it for the purpose of providing our services.
            </Text>
            ...
            <Text style={[styles.listItem, { color: colors.textSecondary }]}>
              • Interfering with the security of the app
            </Text>
            <Text style={[styles.listItem, { color: colors.textSecondary }]}>
            ...
            <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
              ...
              applicable data protection laws, including GDPR. For more
            ...
            <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
              ...
              violates these Terms of Service or is harmful to other users or
              us.
            </Text>
